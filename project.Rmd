...
Model | Accuracy | Sensitivity | Specificity | CV acc 
---------------------- | ------------- | ------------- | ------------- | ------------- 
**Model 1: Logistic Regression with Exploratory Variables** | 0.8484 | 0.14201 | 0.98721 | 0.8416292 
**Model 2: Logistic Regression with All Variables** | 0.897 | 0.51479 | 0.8785603 | 0.8785603 
**Model 3: Logistic Regression with Most Important Variables** | 0.8397 | 0.13609 | 0.8416008 | 0.8416008 
**Model 4: LASSO with "Best" Lambda** | 0.8931 | 0.47929 | 0.97442 | 0.882
**Model 5: LASSO with Different Lambda** | 0.896 | 0.49704 | 0.8416008 | 0.8416008
...
In the future, we should keep trying to find a model with an even higher sensitivity, because the sensitivity is not "good" in any of these models, and we don't want to be making many inaccurate predictions about such an important issue.
